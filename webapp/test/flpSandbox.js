					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Access the Document Management Service",
									"targetURL": "#dmsrobby-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"dmsrobby-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dmsrobby",
									"url": sap.ui.require.toUrl("dmsrobby")
								}
							}
						}
					}
